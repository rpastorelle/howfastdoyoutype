...
cp /vagrant/_ops/inventories/dev /etc/ansible/hosts -f
chmod 666 /etc/ansible/hosts
cat /vagrant/_ops/files/authorized_keys >> /home/vagrant/.ssh/authorized_keys
sudo ansible-playbook /vagrant/_ops/playbook.yml -e hostname=$1 --connection=local